<template>
  <section class="flex flex-col gap-20 mb-20 tracking-wide px-4 md:px-8">
    ...
    <div
      class="flex flex-col gap-8 items-center lg:items-start justify-center md:gap-40 lg:flex-row-reverse"
    >
      ...
      <section class="flex flex-col gap-8">
        <h2 class="hidden lg:block text-3xl font-Montserrat font-semibold">
          Personal Details & Payment
        </h2>
        <BillingPaymentForms />
      </section>
