...
const handleForm = () => {
  ...
  // Showing the retrieved values from form
  console.log(store.getters['bookings/pickupLocation'])
  console.log(store.getters['bookings/dropoffLocation'])
  console.log(store.getters['bookings/pickupDate'])
  console.log(store.getters['bookings/dropoffDate'])
  router.push('/choose-vehicle') // Add validation before redirecting
}
</script>
